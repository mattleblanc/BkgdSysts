...
parser.add_option("--splitFlavour", action='store_true', help="Flavour splitting for multi-b", dest="splitFlavour")
...
if options.splitFlavour :
    ...
    for bin in range(1,total_syst_bb.GetNbinsX() + 1):
        ...
        #total_syst.SetBinContent(bin,math.sqrt(total_syst_bb.GetBinContent(bin)*total_syst_bb.GetBinContent(bin)*(frac_bb)+total_syst_cc.GetBinContent(bin)*total_syst_cc.GetBinContent(bin)*(frac_cc)+total_syst_ll.GetBinContent(bin)*total_syst_ll.GetBinContent(bin)*(frac_ll))) # this is the quad sum ... uncorrelated
            total_syst.SetBinContent(bin,total_syst_bb.GetBinContent(bin)*frac_bb+total_syst_cc.GetBinContent(bin)*frac_cc+total_syst_ll.GetBinContent(bin)*frac_ll) # weighted linear sum, correlated
    ...
    for bin in range(1,total_syst.GetNbinsX() + 1):
        total_syst.SetBinContent(bin,math.sqrt(total_syst.GetBinContent(bin)*total_syst.GetBinContent(bin)))
